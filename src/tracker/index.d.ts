export type TrackedProperties = {
   ...
   * @example 'analytics.aircentre.com'
   */
  hostname: string;
   ...
   *
   * @description extracted from `window.navigator.language`
   * @example 'https://analytics.aircentre.com/docs/getting-started'
   */
  referrer: string;
...
export type AirCentreTracker = {
  track: {
     ...
     *
     * @example ```
     * aircentre.track('signup-button', { name: 'newsletter', id: 123 });
     * ```
     */
     ...
     *
     * @example ```
     * aircentre.track({ website: 'e676c9b4-11e4-4ef1-a4d7-87001773e9f2', url: '/home', title: 'Home page' });
     * ```
     */
     ...
     *
     * @example ```
     * aircentre.track((props) => ({ ...props, url: path }));
     * ```
     */
